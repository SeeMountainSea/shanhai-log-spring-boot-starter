...
public class RequestLogAspect {
     ...
     * 是否将日志打印控制台
     */
    @Value("${sayhi.log.consoleShow:false}")
    private boolean consoleShow;

    @Pointcut("@annotation(com.sayrmb.log.annotation.RequestLog)")
